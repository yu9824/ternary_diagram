                ...
                if len(df_data) == 0:
                    ...
                    if 'z' in df_data.columns:
                        ...
                        if main.values['scatter']:
                            td.scatter(df_data.loc[:, materials], **td_options)
                        ...
                        for c in st_color:
                            if 'auto' in c:
                                ...
                                td_options = {'color' : c}
                            td.scatter(df_data.loc[df_data.loc[:, 'color'] == c, materials], **td_options)
                        
                    

                    # define the window layout
                    figpage = WindowBunch('check figure', layout = [
                            [sg.Text('Plot test')],
                    ...
                    while True:
                        ...
                        elif figpage.event in (None, 'Cancel'):
                            break
                    del figpage
